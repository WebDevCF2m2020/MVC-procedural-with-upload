...
function articleLoadFull($connect,$id){
    $id = (int) $id;
    $req = "SELECT a.idarticles, a.articles_title, a.articles_text, a.users_idusers, a.articles_date, u.idusers, u.users_name , GROUP_CONCAT(t.theimages_title SEPARATOR '|||') AS theimages_title, GROUP_CONCAT(t.theimages_name SEPARATOR '|||') AS theimages_name 
    FROM articles a 
	INNER JOIN users u 
		ON a.users_idusers = u.idusers
    LEFT JOIN  articles_has_theimages hi 
